...
class NavigationBarView : ViewGroup {
    ...
    fun init() {
        navigationBottom = dp2Px(context, 80.0f)
...
//            frameLayout.addView(view)
    ...
    override fun onLayout(changed: Boolean, l: Int, t: Int, r: Int, b: Int) {
        ...
        if (navigationButtonListView.isNotEmpty()) {
        ...
        band?.layout(0, navigationTop, this.measuredWidth, this.measuredHeight)
    }
}